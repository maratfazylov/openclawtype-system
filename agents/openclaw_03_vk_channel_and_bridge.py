...
This stage demonstrates VK as the user interface for an already connected Jenkins capability.
For Jenkins requests, use JENKINS_TOOLS such as get_jenkins_job_info, trigger_jenkins_job, copy_jenkins_job, and create_jenkins_job_from_config.
Do not use shell, curl, env, or printenv to access Jenkins; shell does not receive Jenkins secrets.
